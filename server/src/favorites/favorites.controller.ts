...
export class FavoritesController {
  ...
  async add(
    @Param() params: FavoriteProductIdDto,
    @Req() req: AuthenticatedRequest
  ) {
    const result = await this.favoritesService.add(
      req.user.id,
      params.productId
    );
    return this.responseService.success(
      result,
      FAVORITES_CONSTANTS.SUCCESS.ITEM_ADDED
    );
  }
  ...
  async addMultiple(
    ...
    const result = await this.favoritesService.addMultiple(
      req.user.id,
      body.productIds
    );
    return this.responseService.success(
      result,
      FAVORITES_CONSTANTS.SUCCESS.ITEMS_ADDED
    );
  }
  ...
  async remove(
    ...
    return this.responseService.success(
      undefined,
      FAVORITES_CONSTANTS.SUCCESS.ITEM_REMOVED
    );
  }
  ...
  async removeMultiple(
    ...
    return this.responseService.success(
      undefined,
      FAVORITES_CONSTANTS.SUCCESS.ITEMS_REMOVED
    );
  }
  ...
  async clearFavorites(@Req() req: AuthenticatedRequest) {
    ...
    return this.responseService.success(
      undefined,
      FAVORITES_CONSTANTS.SUCCESS.FAVORITES_CLEARED
    );
  }
  ...
  async findAll(@Req() req: AuthenticatedRequest) {
    ...
    return this.responseService.success(
      favorites,
      FAVORITES_CONSTANTS.SUCCESS.FAVORITES_LOADED
    );
  }
  ...
  async getFavoritesCount(@Req() req: AuthenticatedRequest) {
    ...
    return this.responseService.success(
      { count },
      FAVORITES_CONSTANTS.SUCCESS.COUNT_LOADED
    );
  }
  ...
  async getFavoriteStatus(
    @Req() req: AuthenticatedRequest,
    @Query() query: ProductIdsQueryDto
  ) {
    const status = await this.favoritesService.getFavoriteStatus(
      req.user.id,
      query.productIds
    );
    return this.responseService.success(
      status,
      FAVORITES_CONSTANTS.SUCCESS.STATUS_LOADED
    );
  }
}

...
const RecoveryForm = () => {
  ...
  const [
    ...
    {
      isLoading: isLoadingRequestReset,
      isSuccess: isSuccessRequestReset,
          ...
          {isSuccessRequestReset ? (
            <Fade in={true} timeout={700}>
              <p className="text-center">
                На указанный вами адрес было отправлено письмо с инструкциями по
            ...
            <>
              ...
              {errorRequestReset && (
                <Alert severity="error" sx={{ mb: 2 }}>
                  {'data' in errorRequestReset
                    ? (errorRequestReset.data as ErrorResponse)?.message
                    : 'Произошла ошибка'}
                </Alert>
              )}
              <MainButton
                text="Восстановить"
                disabled={isLoadingRequestReset || isSuccessRequestReset}

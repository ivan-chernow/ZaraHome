...
export class SearchUsersDto {
  ...
  @IsOptional()
  @IsString()
  @Min(USERS_CONSTANTS.MIN_SEARCH_QUERY_LENGTH, {
    message: USERS_CONSTANTS.ERRORS.SEARCH_QUERY_TOO_SHORT,
  })
  @Max(USERS_CONSTANTS.MAX_SEARCH_QUERY_LENGTH, {
    message: USERS_CONSTANTS.ERRORS.SEARCH_QUERY_TOO_LONG,
  })
  query?: string;
  ...
  @Type(() => Number)
  @IsNumber({}, { message: USERS_CONSTANTS.ERRORS.INVALID_PAGINATION })
  @Min(USERS_CONSTANTS.MIN_PAGE_SIZE, {
    message: USERS_CONSTANTS.ERRORS.INVALID_PAGINATION,
  })
  @Max(USERS_CONSTANTS.MAX_PAGE_SIZE, {
    message: USERS_CONSTANTS.ERRORS.INVALID_PAGINATION,
  })

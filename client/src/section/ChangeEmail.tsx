...
const ChangeEmail = () => {
  ...
  const [changeEmail, { isLoading, error: errorChangeEmail, isSuccess: isSuccessChangeEmail }] = useChangeEmailMutation();
      ...
      <div className=''>
        ...
        {errorChangeEmail && (
          <Alert severity="error" className="mb-4">
            {('data' in errorChangeEmail && (errorChangeEmail.data as { message: string })?.message) || ''}
          </Alert>
        )}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mb-[5px]">
          <div className="flex items-center  mb-[23px]">
            <div className="flex flex-col mr-[27px]">
              <label htmlFor="" className='mb-[5px] pl-[20px] font-medium text-[14px] text-[#00000099]'>Текущий email</label>
            ...
            <div className="flex flex-col">
              <label htmlFor="" className='mb-[5px] pl-[20px] font-medium text-[14px] text-[#00000099]'>Новый E-mail</label>
              <TextField sx={{ width: '410px', height: '48px' }}

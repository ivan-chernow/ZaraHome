...
export { Type } from '../products/entity/type.entity';
export { Product } from '../products/entity/products.entity';
...
export { PromocodeUsage } from '../promocodes/entity/promocode-usage.entity';

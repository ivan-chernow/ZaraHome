      ...
      <div>
        ...
        >
          ...
          <div className="mb-[25px] flex items-center justify-center">
            ...
            <p className="font-medium text-[#0000004D] px-[12px]">
              Регистрация
            </p>
            <HorizontalLine width="125px" />
          </div>
              ...
              <>
                ...
                <TextField
                  ...
                  helperText={
                    ...
                    (initiateError && 'data' in initiateError
                      ? (initiateError.data as ErrorData)?.message
                      : '')
                  }
                ...
                <MainButton
                  text="Регистрация"
                  disabled={isInitiateLoading || isInitiateSuccess}
                  onClick={handleSubmit(onSubmitInitiateRegistration)}
                  type="submit"
                  width="358px"
                  height="56px"
                />
              ...
              <Fade in={true} timeout={700}>
                <div>
                  <p className="mb-[26px] text-center">
                    На указанный вами адрес было отправлено письмо с проверочным
                    кодом
                  </p>
                  ...
                  {verifyError && (
                    <Alert severity="error" sx={{ mb: 2 }}>
                      {'data' in verifyError
                        ? (verifyError.data as ErrorData)?.message
                        : 'Неверный код'}
                    </Alert>
                  )}
                  <MainButton
              ...
              <>
                {!isCompleteLoading && !isCompleteSuccess ? (
                  <div className="flex flex-col items-center justify-center">
                    <p className="text-center text-green-700 text-[20px] font-medium mb-3">
                      Подтверждение прошло успешно!
                    </p>
                    <p className="text-black text-[20px] font-medium mb-6">
                  ...
                  <Fade in={true} timeout={700}>
                    <div className="flex flex-col items-center justify-center">
                      <h2 className="text-center text-green-700 text-[20px] font-medium mb-3">

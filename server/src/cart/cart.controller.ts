...
export class CartController {
  ...
  constructor(cartService: CartService, responseService: ResponseService) {
  ...
  async add(@Req() req: AuthenticatedRequest, @Param() params: ProductIdDto) {
    const userId = req.user.id;
    const result = await this.cartService.addToCart(userId, params.productId);
    return this.responseService.success(
      result,
      CART_CONSTANTS.SUCCESS.ITEM_ADDED
    );
  }
  ...
  async addMultiple(
    ...
    const userId = req.user.id;
    const result = await this.cartService.addMultipleToCart(
      userId,
      body.productIds
    );
    return this.responseService.success(
      result,
      CART_CONSTANTS.SUCCESS.ITEMS_ADDED
    );
  }
  ...
  async remove(
    ...
    return this.responseService.success(
      undefined,
      CART_CONSTANTS.SUCCESS.ITEM_REMOVED
    );
  }
  ...
  async removeMultiple(
    ...
    return this.responseService.success(
      undefined,
      CART_CONSTANTS.SUCCESS.ITEMS_REMOVED
    );
  }
  ...
  async clearCart(@Req() req: AuthenticatedRequest) {
    ...
    return this.responseService.success(
      undefined,
      CART_CONSTANTS.SUCCESS.CART_CLEARED
    );
  }
  ...
  async getUserCart(@Req() req: AuthenticatedRequest) {
    ...
    return this.responseService.success(
      cart,
      CART_CONSTANTS.SUCCESS.CART_LOADED
    );
  }
  ...
  async getCartItemCount(@Req() req: AuthenticatedRequest) {
    ...
    return this.responseService.success(
      { count },
      CART_CONSTANTS.SUCCESS.COUNT_LOADED
    );
  }
  ...
  async status(
    ...
    const userId = req.user.id;
    const status = await this.cartService.getCartStatus(
      userId,
      query.productIds
    );
    return this.responseService.success(
      status,
      CART_CONSTANTS.SUCCESS.STATUS_LOADED
    );
  }
}

...
import ArrowBackIconCart from '@/components/ArrowBackIcon';
import { useDispatch } from 'react-redux';
import { emailValidation, getRepeatPasswordValidation, getPasswordValidation } from '@/vaildation/validation';
import { useForm } from 'react-hook-form';
import { useCompleteRegistrationMutation, useInitiateRegistrationMutation, useVerifyCodeMutation } from '@/api/auth.api';
import { closeModalAuth } from '@/store/features/auth/auth.slice';
